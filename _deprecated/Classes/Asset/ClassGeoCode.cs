...
namespace SDB.Classes.Asset
{
	...
	{
		private const string _GOOGLE_MAP_API_BASE_URL = @"http://maps.googleapis.com/maps/api/geocode/";
		...
		{
			// Google Maps API v3
			var args = string.Format(@"json?address={0}&sensor=false", HttpUtility.UrlEncode(address));
