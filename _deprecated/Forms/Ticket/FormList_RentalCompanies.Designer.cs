namespace SDB.Forms.Ticket
{
	partial class FormList_RentalCompanies
	{
		...
		private void InitializeComponent()
		{
			...
			this.olcPrismviewAccount = ((BrightIdeasSoftware.OLVColumn)(new BrightIdeasSoftware.OLVColumn()));
			...
			this.olvRentalCompanies.AllColumns.Add(this.olcPrismviewAccount);
			...
			// olcYescoAccount
			// 
			this.olcPrismviewAccount.AspectName = "PrismviewAccount";
			this.olcPrismviewAccount.CellPadding = null;
			this.olcPrismviewAccount.Groupable = false;
			this.olcPrismviewAccount.IsEditable = false;
			this.olcPrismviewAccount.Text = "Prismview Account";
			this.olcPrismviewAccount.Width = 100;
			// 
			// olcTelephone
			// 
		...
		private BrightIdeasSoftware.OLVColumn olcPrismviewAccount;
