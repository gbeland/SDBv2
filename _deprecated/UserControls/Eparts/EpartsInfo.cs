       ...
       private void PopulateAssembly()
        ...
        private void btnEmailCustomerInfo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                email.To.Add("eparts@prismview.com");
            ...
            email.Body = "We will need some information before We can get you a quote.  \n" +
                "\nCould you get a picture of the label on the back of the LED board and answer these questions?\n" +
                "\nFirst time ordering parts from prismview? (Yes / No):\n" +
                "\nCompany Name:\n" +
                "\nBilling Address:\n" +
                "\nShipping Address:\n" +
            ...
            Classes.Admin.ClassEmailQueue.Add(Classes.Admin.ClassEmailQueue.EmailTypeEnum.EpartsOrder, email);
