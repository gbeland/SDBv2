...
namespace SDB.Classes.Asset
{
	public class ClassAsset : ISupportsJournal, IExportableToCsv
	{
		...
		private static readonly string[] _assetDBFields =
		{
            ...
            "creative_c", "cradlepoint_c", "cradlepoint_c_start_dt", "cradlepoint_c_end_dt", "creative_c_start_dt", "creative_c_end_dt"
        };
        ...
        public int? PlayerSoftwareId { get; set; }
		...
		public class ClassWarrantyInfo
		{
            ...
            public string CradlepointContract { get; set; }
            public string CreativeContract { get; set; }
            public DateTime? CradlepointStart { get; set; }
            public DateTime? CradlepointExpire { get; set; }
            public DateTime? CreativeStart { get; set; }
            public DateTime? CreativeExpire { get; set; }
		...
		public class ClassNetworkInfo
		{
            ...
            public string CradlepointMAC { get; set; }
            public string CradlepointEmail { get; set; }
            public bool Is_Cradlepoint { get; set; }
		...
		public ClassAsset()
		{
            ...
            WarrantyInfo = new ClassWarrantyInfo
            {
                ...
                BillToMarket = false,
                CradlepointContract = string.Empty,
                CradlepointStart = null,
                CradlepointExpire = null,
                CreativeContract = string.Empty,
                CreativeStart = null,
                CreativeExpire = null,
            };
		...
		public string URL_CameraImage(ClassCameraType cameraType)
		{
			...
			string port = ":" + Net.Webcam_Port.GetValueOrDefault(CAMERA_DEFAULT_PORT).ToString();
		...
		/// Gets all assets.
		/// </summary>
		public static List<ClassAsset> GetAll()
        {
            var assets = new List<ClassAsset>();
            using (var conn = ClassDatabase.CreateMySqlConnection())
            {
		...
		public static void AddNew(ref ClassAsset asset)
		{
			using (var conn = ClassDatabase.CreateMySqlConnection())
			{
				...
				using (var cmd = conn.CreateCommand())
				{
                    ...
                    cmd.Parameters.AddWithValue("player_sw", asset.PlayerSoftwareId);
                    ...
                    cmd.Parameters.AddWithValue("cradlepoint_mac", asset.Net.CradlepointMAC);
                    cmd.Parameters.AddWithValue("cradlepoint_email", asset.Net.CradlepointEmail);
                    cmd.Parameters.AddWithValue("is_cradlepoint", asset.Net.Is_Cradlepoint);
                    cmd.Parameters.AddWithValue("creative_c", asset.WarrantyInfo.CreativeContract);
                    cmd.Parameters.AddWithValue("cradlepoint_c", asset.WarrantyInfo.CradlepointContract);
                    cmd.Parameters.AddWithValue("cradlepoint_c_start_dt", asset.WarrantyInfo.CradlepointStart);
                    cmd.Parameters.AddWithValue("cradlepoint_c_end_dt", asset.WarrantyInfo.CradlepointExpire);
                    cmd.Parameters.AddWithValue("creative_c_start_dt", asset.WarrantyInfo.CreativeStart);
                    cmd.Parameters.AddWithValue("creative_c_end_dt", asset.WarrantyInfo.CreativeExpire);
				...
				using (var cmd = conn.CreateCommand())
				{
					cmd.CommandText =
                        @"UPDATE assets SET
                            ...
                            cradlepoint_c = @cradlepoint_c,
                            cradlepoint_c_start_dt = @cradlepoint_c_start_dt,
                            cradlepoint_c_end_dt = @cradlepoint_c_end_dt,
                            creative_c_start_dt = @creative_c_start_dt,
                            creative_c_end_dt = @creative_c_end_dt
						WHERE id = @AssetID;";
					cmd.Parameters.AddWithValue("AssetID", asset.ID);
					cmd.Parameters.AddWithValue("labor_w", asset.WarrantyInfo.LaborWarrantyNumber);
					cmd.Parameters.AddWithValue("labor_c", asset.WarrantyInfo.LaborContractNumber);
		...
		private static ClassAsset GetFromReader(MySqlDataReader reader)
		{
            var asset = new ClassAsset
            {
                ...
                PlayerSoftwareId = reader.GetDBInt_Null("player_sw"),
				...
				Net = new ClassNetworkInfo
				{
                    ...
                    CradlepointEmail = reader.GetDBString("cradlepoint_email"),
                    CradlepointMAC = reader.GetDBString("cradlepoint_mac"),
                    Is_Cradlepoint = reader.GetDBBool("is_cradlepoint")
				...
				WarrantyInfo = new ClassWarrantyInfo
				{
                    ...
                    BillToMarket = reader.GetDBBool("bill_to_market"),
                    ...
                    CreativeContract = reader.GetDBString("creative_c"),
                    CreativeStart = reader.GetDBDateTime_Null("creative_c_start_dt"),
                    CreativeExpire = reader.GetDBDateTime_Null("creative_c_end_dt"),

                    CradlepointContract = reader.GetDBString("cradlepoint_c"),
                    CradlepointStart = reader.GetDBDateTime_Null("cradlepoint_c_start_dt"),
                    CradlepointExpire = reader.GetDBDateTime_Null("cradlepoint_c_end_dt")
				},
