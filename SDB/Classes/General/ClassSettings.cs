...
namespace SDB.Classes.General
{
	...
	public class ClassSettings
	{
		...
		[XmlIgnore]
		public readonly string SettingsPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"SEA", @"NOC Service Database");
		...
		/// <summary>
		/// Name of database for NOC Service Database
		/// </summary>
		public string DBName_Service = @"electronics";

		/// <summary>
		/// Name of database for PVM
		/// </summary>
		...
		/// </summary>
		public string DBUser = @"SDB_Client";
		...
		/// <summary>
		/// Location of RealVNC Viewer executable.
		/// </summary>
		...
		public void SaveSettings()
		{
			...
			DBPassword = Admin.ClassEncDec.Encrypt(DBPassword, "NOC");
			EmailPassword = Admin.ClassEncDec.Encrypt(EmailPassword, "NOC");
		...
		public ClassSettings LoadSettings()
		{
			...
			using (var sr = new StreamReader(Path.Combine(SettingsPath, SETTINGS_FILE)))
			{
				try
				{
					...
					temp.DBPassword = Admin.ClassEncDec.Decrypt(temp.DBPassword, "NOC");
					temp.EmailPassword = Admin.ClassEncDec.Decrypt(temp.EmailPassword, "NOC");
				}
				catch
				{
