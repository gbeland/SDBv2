namespace SDB.Forms.General
{
    partial class FormSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.lblSamsungDBName = new System.Windows.Forms.Label();
			...
			this.pnlServer.Controls.Add(this.lblSamsungDBName);
			...
			this.tbxSamsungDBName.TabIndex = 14;
			...
			// lblSamsungDBName
			// 
			this.lblSamsungDBName.AutoSize = true;
			this.lblSamsungDBName.Location = new System.Drawing.Point(213, 95);
			this.lblSamsungDBName.Margin = new System.Windows.Forms.Padding(2, 0, 2, 0);
			this.lblSamsungDBName.Name = "lblSamsungDBName";
			this.lblSamsungDBName.Size = new System.Drawing.Size(131, 13);
			this.lblSamsungDBName.TabIndex = 13;
			this.lblSamsungDBName.Text = "Samsung Database Name";
			// 
			// lblDatabaseServer
			// 
			...
			this.lblServer_Timeout.TabIndex = 6;
			this.lblServer_Timeout.Text = "Timeout:";
			// 
			// lblServer_TimeoutSeconds
			// 
			this.lblServer_TimeoutSeconds.AutoSize = true;
			this.lblServer_TimeoutSeconds.Location = new System.Drawing.Point(114, 138);
			...
			this.lblServer_TimeoutSeconds.TabIndex = 8;
			...
			this.numServer_Timeout.TabIndex = 7;
			...
			this.txtDBName_Monitoring.TabIndex = 12;
			...
			this.txtDBName_Service.TabIndex = 10;
        ...
        "ectronics\"");
			...
			this.lblDBName_Monitoring.TabIndex = 11;
			...
			this.lblDBName_Service.TabIndex = 9;
			...
			this.txtServer_User.TabIndex = 3;
        ...
        "nal user ID.");
			...
			this.lblServer_User.TabIndex = 2;
			...
			this.txtServer_Password.TabIndex = 5;
			...
			this.lblServer_Password.TabIndex = 4;
			...
			this.txtServer_Server.TabIndex = 1;
			...
			this.lblServer_Server.TabIndex = 0;
        ...
        " email account.");
			...
			this.radStartupScreen_MagicInfo.TabIndex = 6;
			...
			this.chkCameraCheckEnable.TabIndex = 7;
			...
			this.numVNCTimeout.TabIndex = 10;
			...
			this.txtVNCPasswordWindowTitle.TabIndex = 8;
			...
			this.tbxRealVNCPath.TabIndex = 5;
			...
			this.lblVNCPasswordWindowTitle.TabIndex = 7;
			...
			this.lblVNCTimeoutSeconds.TabIndex = 11;
        ...
        private System.Windows.Forms.Label lblSamsungDBName;
