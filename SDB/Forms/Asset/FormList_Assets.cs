...
namespace SDB.Forms.Asset
{
	public partial class FormList_Assets : Form
	{
		...
		public FormList_Assets(List<ClassAsset> customAssetList = null, string searchTerm = null)
		{
            ...
            if (customAssetList == null)
            {
                _assetList = ClassAsset.GetAll();
        ...
        private void PopulateAssetList()
		{
            ...
            int _start = _page * _MAX_RESULTS_PER_PAGE;
            olvAssets.Objects = (_assetList.GetRange(_start, _MAX_RESULTS_PER_PAGE));
            _assetCount = _assetList.Count;
            HandlePagination();
		...
		private void btnExport_Click(object sender, EventArgs e)
		{
			using (var sfd = new SaveFileDialog())
			{
				...
				try
				{
                    ...
                    List<ClassAsset> filteredViewList = (List < ClassAsset > )olvAssets.Objects;

                    var _filter = olvAssets.ListFilter;
                    var _sort = olvAssets.Sorting;

                    olvAssets.Objects = _assetList;

                    allAssets.AddRange(olvAssets.FilteredObjects.Cast<ClassAsset>());

                    olvAssets.Objects = filteredViewList;
