...
namespace SDB.Forms.Ticket
{
	partial class FormTicket_Rental
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtRental_AccountNumber = new System.Windows.Forms.TextBox();
			this.lblRental_AccountNumber = new System.Windows.Forms.Label();
			...
			this.pnlRental.Controls.Add(this.txtRental_AccountNumber);
			this.pnlRental.Controls.Add(this.lblRental_AccountNumber);
			...
			// 
			this.txtRental_AccountNumber.Location = new System.Drawing.Point(354, 47);
			this.txtRental_AccountNumber.Name = "txtRental_AccountNumber";
			this.txtRental_AccountNumber.ReadOnly = true;
			this.txtRental_AccountNumber.Size = new System.Drawing.Size(125, 20);
			this.txtRental_AccountNumber.TabIndex = 6;
			// 
			// lblRental_YescoAccount
			// 
			this.lblRental_AccountNumber.AutoSize = true;
			this.lblRental_AccountNumber.Location = new System.Drawing.Point(258, 50);
			this.lblRental_AccountNumber.Name = "lblRental_AccountNumber";
			this.lblRental_AccountNumber.Size = new System.Drawing.Size(90, 13);
			this.lblRental_AccountNumber.TabIndex = 5;
			this.lblRental_AccountNumber.Text = "Account #";
			// 
			// olvRentalDivisions
			// 
		...
		private System.Windows.Forms.TextBox txtRental_AccountNumber;
		private System.Windows.Forms.Label lblRental_AccountNumber;
