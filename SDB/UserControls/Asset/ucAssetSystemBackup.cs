...
namespace SDB.UserControls.Asset
{
	public partial class ucAssetSystemBackup : UserControl
	{
		...
		private void btnRestoreBackup_Click(object sender, EventArgs e)
		{
			...
			confirmThisAsset += string.Format("Select \"No\" to select a different asset to restore to.{0}{0}This will issue a restart command to PV System.", Environment.NewLine);
				...
				case DialogResult.No:
					...
					do
					{
						...
						if (selectedAsset == null)
							return;
						var confirmAsset = string.Format("Do you want to restore the backup dated {0:yyyy-MM-dd HH:mm:ss} to {1}? This will issue a restart command to PV System.", selectedBackup.BackupDate, selectedAsset.AssetName);
