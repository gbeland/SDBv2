...
namespace SDB.UserControls.Asset
{
	...
	public partial class AssetEditor : UserControl
	{
		...
		private void LockControls_Network(bool isLocked)
		{
            ...
            //Cradlepoint
            tbxCradlepointEmail.ReadOnly = isLocked;
            tbxCradlepointMAC.ReadOnly = isLocked;
            cbxIsCradlepoint.Enabled = !isLocked;
		...
		private void Populate()
		{
            ...
            if (_asset.ManagedByCreative)
                pnlOwnershipInformation.BackColor = Color.LightSalmon;
            else
                pnlOwnershipInformation.BackColor = Color.LightGray;
		...
		private void Populate_Physical()
		{
            ...
            cmbPlayerSoftware.SelectedValue = _asset.PlayerSoftwareId ?? -1;
        ...
        private void Populate_ComboBoxLists()
        {
            ...
            cmbPlayerSoftware.DataSource = _playerSoftwares;
		...
		private void Populate_Network()
		{
            ...
            //Cradlepoint
            tbxCradlepointEmail.Text = _asset.Net.CradlepointEmail;
            tbxCradlepointMAC.Text = _asset.Net.CradlepointMAC;
            cbxIsCradlepoint.Checked = _asset.Net.Is_Cradlepoint;

            if (_asset.Net.Is_Cradlepoint)
            {
                pnlAdditional.BackColor = Color.MediumPurple;
                pnlCradlepoint.BackColor = Color.MediumPurple;
            }
            else
            {
                pnlAdditional.BackColor = Color.WhiteSmoke;
                pnlCradlepoint.BackColor = Color.LightGray;
            }
		...
		private void UpdateAssetObjectFromFields()
		{
            ...
            _asset.PlayerSoftwareId = (int?)cmbPlayerSoftware.SelectedValue;
		...
		private void UpdateAssetNetworkOptionsFromFields()
		{
            ...
            //Cradlepoint
            _asset.Net.Is_Cradlepoint = cbxIsCradlepoint.Checked;
            _asset.Net.CradlepointEmail = tbxCradlepointEmail.Text;
            _asset.Net.CradlepointMAC = tbxCradlepointMAC.Text;
		...
		public void Asset_Load(int assetID)
		{
            ...
            _playerSoftwares = ClassPlayerSoftware.GetAll().OrderBy(ch => ch.Description).ToList();
        ...
        private void txtNetwork_WAN_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://" + _asset.Net.WanAddress);
            }
            catch { }
        }
